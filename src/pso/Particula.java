...
public class Particula {
	...
	public static double[] posicao; // vetor de pontos que definem a posicao da particula no hiperplano (PERGUNTAR A GEORGE)
	public static ArrayList<double[]> posicoes; // memoria de posicoes antes dos deslocamentos
	public static double[] velocidade; // velocidade da particula durante o deslocamento (PERGUNTAR A GEORGE)

	public Particula(int numNeuronios) { //construtor
		this.posicao = new double[numNeuronios]; // cria a posicao d-dimensional
		this.velocidade = new double[numNeuronios]; // (DESSA FORMA FICA 1 VELOCIDADE PRA CADA POSICAO)
